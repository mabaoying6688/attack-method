...
if __name__ == "__main__":
    ...
    parser.add_argument('-save_dir', default="../adv_model/adv_COM")
    parser.add_argument('-model', "LSTM")
    ...
    parser.add_argument('--adv_train_size', type=int, default=1800)
...
#             torch.optim.Adam(classifier.parameters(), lr=0, betas=(0.9, 0.98), eps=1e-9))
    ...
    trainEpochs(30, training_set, valid_set, saving_path=opt.save_dir)
    print()
    print()
