...
class CombinedAttacker(object):
    ...
    def attack(self,x_token,x, y, uids, poses, rand_d=None, vocab_cnt_test=None,n_candidate=100, n_iter=20):
        ...
        # print("Both token and ins attacks failed.")
        return False, x, y
...
if __name__ == "__main__":
    ...
    classifier.load_state_dict(torch.load('../author_GRU/best_model.pt'))
    

    attacker = CombinedAttacker(poj, symtab, instab, classifier)
    attacker.attack_all(10, 20, res_save="../MHM-GRU_author_atk.advsamples.pkl.gz", adv_sample_size=2000) #atk.attack_all(40, 50, res_save="../model/lstm/uid_rename_atk_candi40_iter50.advsamples.pkl.gz", adv_sample_size=500)
