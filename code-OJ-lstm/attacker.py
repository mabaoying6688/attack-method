...
if __name__ == "__main__":
    ...
    codebert_mlm = RobertaForMaskedLM.from_pretrained(opt.base_model)
    tokenizer_mlm = RobertaTokenizer.from_pretrained(opt.base_model)
    ...
    classifier.load_state_dict(torch.load('../code-OJ-lstm/model/PATH45.pt'))
    #=========================== attack after adv-training =========================
