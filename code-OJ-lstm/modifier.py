...
class TokenModifier(object):
    ...
    def __init__(self, classifier, loss, uids, txt2idx, idx2txt):
        ...
        global sh_forbidden_uid
        sh_forbidden_uid = self.forbidden_uid      
        e_uids = ["<unk>"]
        for uid in uids:
    ...
    def __gen_uid_vocab1(self, dictionary):
        ...
        _uids1 = torch.zeros(vocab_size, dtype=torch.float32)  # 设置数据类型为浮点数
...
class InsModifier(object):
    ...
    def __init__(self, classifier, txt2idx, poses=None):
        ...
        global sh_forbidden_uid
        self.sh_forbidden_uid = sh_forbidden_uid
...
if __name__ == "__main__":
    ...
    classifier.load_state_dict(torch.load('../code-OJ-lstm/model/PATH12.pt'))
