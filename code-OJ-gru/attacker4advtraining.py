...
voc_file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '/home/mby/CARROT-code/CARROT-main', 'preprocesslstm-MY', 'vocab_cnt_test.json') 
...
class CombinedAttacker(object):
    ...
    def attack_all(self, n_candidate=100, n_iter=20, res_save=None, adv_sample_size=5000):
        ...
        st_time = time.time()
        with open('../preprocesslstmMY/vocab_cnt_test.json', 'r') as VOCA:  
...
if __name__ == "__main__": 
    ...
    classifier.load_state_dict(torch.load('../code-OJ-GRU/model20.pt'))
    attacker = CombinedAttacker(poj, symtab, instab, classifier)
    attacker.attack_all(40, 50, res_save="../GRU_oj_5000.advsamples.pkl.gz", adv_sample_size=5000)
