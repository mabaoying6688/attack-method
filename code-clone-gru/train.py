...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default="../model/model_initial")
    ...
    # parser.add_argument('--adv_train_path', type=str, default="/home/mby/CARROT-code/CARROT-main/my-code_clone-GRU/human_eval/25-3-11-MY_insert_codeclone_GRU_500.advsamples.pkl.gz")
    # parser.add_argument('--adv_train_size', type=int, default=500)       
    ...
    poj = OJ104(path=opt.data,
                ...
                )      # if you have adversarial samples
