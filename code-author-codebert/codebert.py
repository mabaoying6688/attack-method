...
class CodeBERTClassifier(nn.Module):
    def __init__(self, model_path, num_labels, device=None):
        ...
        self.device = device
        self.max_len = 512  # 后添加这一行
        CodeBERTClassifier.counter = 0# 初始化类属性counter 后添加   
...
if __name__ == "__main__":
    ...
    oj = OJ104(path="../data_author/author.pkl.gz")
    model = CodeBERTClassifier('../codebert-base-mlm', 66).train()
