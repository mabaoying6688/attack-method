...
class OJ104(object):
    ...
    def __init__(self, path='../data_clone/oj.pkl.gz', max_stmt_len=20, max_stmt_cnt=40,
                 vocab_size=2000, valid_ratio=0.2, dtype='32',adv_train_path=None, adv_train_size=None):
