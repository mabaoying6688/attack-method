...
class CombinedAttacker(object):
    ...
    def attack(self,x, y, uids, poses, rand_d=None, vocab_cnt_test=None,n_candidate=100, n_iter=20):
        x_token=x
        token_success, token_adv_x1, token_adv_y1= self._attack_ins(x_token,x, y, poses, rand_d, n_candidate, n_iter)
        if token_success:
            return True, token_adv_x1, token_adv_y1        
    ...
    def attack_all(self, n_candidate=100, n_iter=20,relax=1,res_save=None, adv_sample_size=5000):
        ...
        with open('../code-OJ-lscnn/vocab_cnt_test.json', 'r') as VOCA:  
...
if __name__ == "__main__":
 ...
 #IECIA
    ...
    attacker.attack_all(20,10,1, res_save="../oj_lscnn.advsamples.pkl.gz", adv_sample_size=6000) 
